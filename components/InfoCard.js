...
const InfoCard = ({image, title, text, link}) => {
    ...
    return (
        <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', margin: 10, backgroundColor: darkMode ? '#424242' : '#fafafa', borderRadius: 20, paddingVertical: 10}}>
            <Image source={image} />
